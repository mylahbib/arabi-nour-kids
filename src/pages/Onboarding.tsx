...
const Onboarding = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 bg-gradient-to-br from-background via-card/50 to-accent/10">
      <div className="w-full max-w-2xl">
        {step === "start" ? (
          <div className="text-center animate-fade-in">
            <div className="mb-8">
              <img src={mascot} alt="Mascot" className="w-56 mx-auto mb-6 animate-bounce-soft drop-shadow-2xl" />
            </div>

            <Card 
              className="p-8 shadow-duolingo-xl border-4 border-primary/30 relative overflow-hidden bg-card/95 backdrop-blur-sm rounded-3xl"
              style={{
            ...
            >
              <div className="relative z-10">
                <h2 className="text-4xl font-bold mb-6 text-primary" style={{ fontFamily: "'Noto Kufi Arabic', sans-serif" }}>
                  مرحبا بك في خطوة
                </h2>
                <p className="text-xl text-muted-foreground mb-8 font-semibold">ابدأ رحلتك في تعلم العربية</p>
                ...
                <div className="space-y-4">
                  ...
                  >
                    ...
                    <span className="text-xl font-bold">تسجيل الدخول بجوجل</span>
                  </Button>
          ...
          <div className="text-center animate-fade-in">
            <div className="mb-8 animate-float">
              ...
              <p className="text-xl text-muted-foreground font-semibold">تعلم أساسيات اللغة العربية</p>
            </div>

            <Card className="p-8 shadow-duolingo-xl border-4 border-primary/30 rounded-3xl bg-card">
          ...
          <div className="text-center animate-fade-in">
            <div className="mb-8">
              ...
              <p className="text-xl text-muted-foreground font-semibold">نحن سعداء بلقائك</p>
            </div>
              ...
              <div className="space-y-6 text-right" dir="rtl">
                <div>
                  ...
                  <Input
                    ...
                    className="text-2xl h-16 text-center border-2 border-primary/30 focus:border-primary rounded-3xl bg-background"
                ...
                <div className="flex gap-3 pt-4">
                  ...
                  >
                    <span className="text-xl font-bold">رجوع</span>
                  </Button>
                  <Button
                    variant="kid"
                    size="lg"
            ...
            <div className="mt-6 flex items-center justify-center gap-2 text-muted-foreground">
              <span className="text-lg font-semibold">اللهجة المختارة:</span>
